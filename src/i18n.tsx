...
const rows: TranslationRow[] = [
  ...
  ,["Explore impact","Explorar impacto","Explorer l’impact","Explorar el impacto","Изучить влияние","探索影响","استكشاف الأثر"]
  ,["Investigate grants through the live map, filters and project records.","Investigue subsídios por meio do mapa interativo, filtros e registros de projetos.","Explorez les subventions grâce à la carte interactive, aux filtres et aux fiches de projets.","Investigue las subvenciones mediante el mapa interactivo, los filtros y los registros de proyectos.","Изучайте гранты с помощью интерактивной карты, фильтров и записей проектов.","通过实时地图、筛选器和项目记录研究赠款。","استكشف المنح من خلال الخريطة التفاعلية والمرشحات وسجلات المشاريع."]
  ...
  ,["Deliver and improve","Executar e melhorar","Mettre en œuvre et améliorer","Implementar y mejorar","Реализовать и улучшить","实施与改进","التنفيذ والتحسين"]
  ,["Reach saved work, support and future agency-authorized workflows.","Acesse trabalhos salvos, suporte e futuros fluxos autorizados pelas agências.","Accédez aux travaux enregistrés, à l’assistance et aux futurs processus autorisés par les agences.","Acceda al trabajo guardado, al soporte y a futuros flujos autorizados por las agencias.","Открывайте сохранённую работу, поддержку и будущие процессы, разрешённые агентствами.","访问已保存工作、支持和未来经机构授权的工作流程。","الوصول إلى العمل المحفوظ والدعم ومسارات العمل المستقبلية المعتمدة من الوكالات."]
